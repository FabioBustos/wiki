...
-   **Prefijos Descriptivos**: Usar [[prefix|prefixes]] para organizar, especialmente en [[cloudflare-r2]].
...
- [[cloudflare-r2]] / [[amazon-s3]] (I will create this file later if it doesn't exist) - Organización de archivos mediante prefixes.
- [[git]] (I will create this file later if it doesn't exist) - Convenciones para nombres de ramas y mensajes de commit.
- [[obsidian]] (I will create this file later if it doesn't exist) - Cómo se enlazan los documentos wiki.
