...
1.  **Almacenamiento de Objetos**: Costo por GB almacenado.
    ...
    -   **Optimización**: Usar [[politica-de-ciclo-de-vida]] para eliminar datos obsoletos, comprimir archivos.
...
-   **Automatización**: Usar [[politica-de-ciclo-de-vida]] para gestionar el almacenamiento y scripts para apagar/encender recursos.
